...
export type PublicationInfo = Omit<Publication, 'createdAt' | 'updatedAt' | 'authors'> & {
...
export const memberProfileIncludeArgs = {
    ...
    authoredPublications: {
        ...
        include: {
            publication: { // 包含关联的 Publication
                select: { // 选择 Publication 的字段
...
export type MemberPayload = Prisma.MemberGetPayload<{ include: typeof memberProfileIncludeArgs }> & Member;
