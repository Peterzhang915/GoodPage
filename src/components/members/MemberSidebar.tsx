...
type MemberSidebarProps = {
  member: Pick<
    Member,
    | 'avatar_url' | 'name_zh' | 'name_en' | 'email' | 'github_username' 
    | 'personal_website' | 'linkedin_url' | 'google_scholar_id' | 'dblp_id' 
    | 'cv_url' | 'office_location' | 'office_hours' | 'recruiting_status' 
    | 'skills' | 'status' | 'enrollment_year' // Needed for status logic if not precalculated
  > & { 
...
const MemberSidebar: React.FC<MemberSidebarProps> = ({ member, displayStatus }) => {
