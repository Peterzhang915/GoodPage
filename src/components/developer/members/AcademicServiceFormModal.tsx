...
export function AcademicServiceFormModal({
  isOpen,
  onClose,
  onSubmit,
  initialData,
  memberId,
}: AcademicServiceFormModalProps) {
  ...
  const {
    ...
    reset,
  } = useForm<AcademicServiceFormData>({
      ...
      <DialogContent className="sm:max-w-[425px] dark:bg-gray-850 dark:border-gray-700">
        <DialogHeader>
          <DialogTitle className="text-green-600 dark:text-green-400 text-xl font-semibold">
            {isEditing ? "Edit" : "Add"} Academic Service
          </DialogTitle>
        </DialogHeader>
        <form
        ...
        >
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            />
            {errors.organization && (
              <p className="col-span-4 text-sm text-red-500 dark:text-red-400 text-right">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="endYear" className="text-right dark:text-gray-300">
              End Year
            </Label>
            <Input
              id="endYear"
          ...
          {errors.isFeatured && (
            <p className="text-sm text-red-500 dark:text-red-400 mt-1 min-h-[1.25em] leading-tight break-all whitespace-normal col-span-4">
