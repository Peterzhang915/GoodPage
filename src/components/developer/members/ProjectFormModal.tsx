    ...
    end_year: z
      ...
      .refine(
        (val) => {
          ...
          const num = Number(val);
          return (
            !isNaN(num) && num >= 1900 && num <= new Date().getFullYear() + 10
          );
        },
        {
      ...
      <DialogContent className="sm:max-w-[525px] dark:bg-gray-850 dark:border-gray-700">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="start_year" className="dark:text-gray-300">
                Start Year
              </Label>
              <Input
                id="start_year"
            ...
            <div>
              <Label htmlFor="end_year" className="dark:text-gray-300">
                End Year
              </Label>
              <Input
                id="end_year"
          ...
          <div>
            ...
            <Input
              id="role"
              {...register("role")}
              placeholder="e.g., PI, Main Developer, Participant"
              className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100"
            />
            {errors.role && (
              <p className="text-sm text-red-500 dark:text-red-400 mt-1">
          ...
          <div>
            ...
            <Input
              id="tags"
              {...register("tags")}
              placeholder="Comma-separated, e.g., React, AI, NLP"
              className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100"
            />
            {errors.tags && (
              <p className="text-sm text-red-500 dark:text-red-400 mt-1">
