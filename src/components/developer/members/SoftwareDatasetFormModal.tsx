...
export function SoftwareDatasetFormModal({
  isOpen,
  onClose,
  onSubmit,
  initialData,
  memberId,
}: SoftwareDatasetFormModalProps) {
  ...
  const {
    ...
    reset,
  } = useForm<SoftwareDatasetFormData>({
      ...
      <DialogContent className="sm:max-w-lg dark:bg-gray-850 dark:border-gray-700">
        <DialogHeader>
          <DialogTitle className="text-green-600 dark:text-green-400 text-xl font-semibold">
            {isEditing ? "Edit" : "Add"} Software/Dataset
          </DialogTitle>
        </DialogHeader>
        <form
          onSubmit={handleSubmit(handleFormSubmit)}
          className="grid gap-4 py-4 max-h-[70vh] overflow-y-auto px-6"
        >
          {/* Title */}
          ...
          {/* License */}
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="license" className="text-right dark:text-gray-300">
              License
            </Label>
            <Input
              id="license"
          ...
          {/* Version */}
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="version" className="text-right dark:text-gray-300">
              Version
            </Label>
            <Input
              id="version"
