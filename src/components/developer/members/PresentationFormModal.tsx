      ...
      <DialogContent className="sm:max-w-md dark:bg-gray-850 dark:border-gray-700">
        <DialogHeader>
          <DialogTitle className="text-green-600 dark:text-green-400 text-xl font-semibold">
            {isEditing ? "Edit" : "Add"} Presentation
          </DialogTitle>
        </DialogHeader>
        <form
        ...
        >
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            />
            {errors.conferenceUrl && (
              <p className="col-span-4 text-sm text-red-500 dark:text-red-400 text-right">
                {errors.conferenceUrl.message}
              </p>
            )}
          </div>
          ...
          {/* Location */}
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="location" className="text-right dark:text-gray-300">
              Location
            </Label>
            <Input
              id="location"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label
              htmlFor="isInvited"
              className="text-right dark:text-gray-300 col-span-1"
            >
              Invited Talk
            </Label>
