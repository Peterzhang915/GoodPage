...
const formatAwardLevelLabel = (level: AwardLevel): string => {
    switch (level) {
        case AwardLevel.GOLD: return 'Gold';
        case AwardLevel.SILVER: return 'Silver';
        case AwardLevel.BRONZE: return 'Bronze';
        case AwardLevel.OTHER: return 'Other / Not Specified';
      ...
      <DialogContent className="sm:max-w-[500px] dark:bg-gray-850 dark:border-gray-700">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-start gap-4">
                <Label htmlFor="content" className="text-right pt-2 dark:text-gray-300">
            ...
            {/* Level (Optional Enum) */}
            <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="level" className="text-right dark:text-gray-300">Level</Label>
                <Controller
                    name="level"
                    control={control}
                    render={({ field }) => (
                        ...
                        >
                            ...
                            <SelectContent className="dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100">
                                ...
                                {Object.values(AwardLevel).map((levelValue) => (
                                    <SelectItem key={levelValue} value={levelValue} className="dark:hover:bg-gray-700 dark:focus:bg-gray-700">
            ...
            {errors.level && <p className="text-sm text-red-500 dark:text-red-400 mt-1 min-h-[1.25em] leading-tight break-all whitespace-normal">{errors.level.message}</p>}
             ...
             {/* Link URL (Optional) */}
             <div className="grid grid-cols-4 items-center gap-4">
                 <Label htmlFor="link_url" className="text-right dark:text-gray-300">Link URL</Label>
                 <Input
                     id="link_url"
                     type="url"
                     {...register("link_url")}
