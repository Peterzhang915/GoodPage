...
import { MemberCard } from '@/components/MemberCard'; // 导入成员卡片组件
  ...
  return (
    <>
      ...
      {sortedGroupKeys.map(groupKey => {
        ...
        return (
          <section key={groupKey} className="mb-12 md:mb-16"> {/* 调整间距 */}
            {/* 分组标题 */}
            <h2 className={`text-2xl md:text-3xl font-semibold ${themeColors.textColorPrimary ?? ''} border-b ${themeColors.footerBorder ?? 'border-gray-300'} pb-3 mb-8 scroll-mt-20`}>
               {/* 这里可以根据需要添加组图标 */}
      ...
      {/* Emoji 切换按钮 */}
      <div className="mt-16 md:mt-24 text-center mx-auto w-full flex justify-center"> {/* 调整上边距 */}
        <button
