...
const ResearchInterestsSection: React.FC<ResearchInterestsSectionProps> = ({ interestsText }) => {
  ...
  return (
    <section id="interests">
      ...
      <div className={`text-sm md:text-base leading-relaxed ${themeColors.textColorSecondary ?? ''} whitespace-pre-wrap`}>
        {content}
      </div>
    </section>
  );
