      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-800">
        ...
        <ContentSection id="news" title="News" viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5 }}> {/* 可以覆盖默认动画参数 */}
          <ul className="list-disc ml-6 space-y-3 text-gray-700">
            <li>We always look for <strong className="font-semibold text-gray-900">self-motivated under/graduate students</strong> who are ready to take on ambitious challenges to join my research group (with <strong className="font-semibold text-gray-900">financial support</strong>)</li>
            <li className="text-red-700"><span className="font-semibold">News:</span> We have won the First Prize of Provincial Technology Advancement Award, the only ONE in Computer Science in 2024.</li>
          </ul>
        </ContentSection>
